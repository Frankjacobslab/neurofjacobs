...
if __name__ == "__main__":
    ...
    parser.add_option("-x", "--extension", dest="extension")
    ...
    if len(args)==0:
        try:
            args = glob.glob(options.indir+'/*'+options.extension)
        except:
            print 'Please provide either an inputfilename as an argument or a directory and extension of inputfiles with -i and -x respectively'
